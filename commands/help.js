...
module.exports = {
    ...
    async execute(message, args) {
        ...
        .addFields(
            ...
            { name: '-goulag [_mention de la personne_]', value: "envoie la personne de ton choix au goulag (requiert la permission d'expulser des membres"},
            { name: '-ungoulag [_mention de la personne_]', value: "libère les gens du goulag (requiert la permission d'expulser des membres"},
