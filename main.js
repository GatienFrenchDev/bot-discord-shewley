...
client.on('message', message => {
    ...
    if(message.content.includes("'-'") || message.content.includes("' - '") || message.content.includes("'_'") || message.content.includes("' _ '") || message.content.includes('"-"') || message.content.includes("' -'") || message.content.includes("'- '")){
        message.delete()
        return
    }
